...
export const CurlImpersonateOpt = {
  ...
  /** Do not combine Cookie headers (long, 0 or 1) */
  CURLOPT_SPLIT_COOKIES: CURLOPTTYPE_LONG + 1023,
  /** Multipart form boundary (string) */
  CURLOPT_FORM_BOUNDARY: CURLOPTTYPE_STRINGPOINT + 1024,
  /** HTTP/3 pseudo header order (string) */
  CURLOPT_HTTP3_PSEUDO_HEADERS_ORDER: CURLOPTTYPE_STRINGPOINT + 1025,
  /** HTTP/3 SETTINGS frame values (string) */
  CURLOPT_HTTP3_SETTINGS: CURLOPTTYPE_STRINGPOINT + 1026,
  /** QUIC transport parameters (string) */
  CURLOPT_QUIC_TRANSPORT_PARAMETERS: CURLOPTTYPE_STRINGPOINT + 1027,
  /** HTTP/3 signature hash algorithms (string) */
  CURLOPT_HTTP3_SIG_HASH_ALGS: CURLOPTTYPE_STRINGPOINT + 1028,
  /** HTTP/3 TLS extension order (string) */
  CURLOPT_HTTP3_TLS_EXTENSION_ORDER: CURLOPTTYPE_STRINGPOINT + 1029,
  /** HTTP header order (string) */
  CURLOPT_HTTPHEADER_ORDER: CURLOPTTYPE_STRINGPOINT + 1030,
  /** HTTP/3 headers (curl_slist) */
  CURLOPT_HTTP3_HTTPHEADER: CURLOPTTYPE_SLISTPOINT + 1031,
  /** HTTP/3 header order (string) */
  CURLOPT_HTTP3_HTTPHEADER_ORDER: CURLOPTTYPE_STRINGPOINT + 1032,
  /** HTTP/3 supported groups (string) */
  CURLOPT_HTTP3_SSL_EC_CURVES: CURLOPTTYPE_STRINGPOINT + 1033,
  /** WebSocket headers (curl_slist) */
  CURLOPT_WS_HTTPHEADER: CURLOPTTYPE_SLISTPOINT + 1034,
  /** WebSocket header order (string) */
  CURLOPT_WS_HTTPHEADER_ORDER: CURLOPTTYPE_STRINGPOINT + 1035,
  /** Disable WebSocket TLS session tickets (long, 0 or 1) */
  CURLOPT_WS_SSL_DISABLE_TICKET: CURLOPTTYPE_LONG + 1036,
  /** WebSocket certificate compression algorithms (string) */
  CURLOPT_WS_SSL_CERT_COMPRESSION: CURLOPTTYPE_STRINGPOINT + 1037,
} as const;
